...
- Create: `README.md`
- Create: `src/envdiff/__init__.py`
- Create: `src/envdiff/cli.py`
- Create: `src/envdiff/models.py`
- Create: `src/envdiff/parsers/__init__.py`
- Create: `src/envdiff/analyzers/__init__.py`
- Create: `src/envdiff/render/__init__.py`
- Create: `src/envdiff/utils/__init__.py`
...
- Modify: `src/envdiff/models.py`
- Create: `src/envdiff/render/json.py`
- Create: `src/envdiff/utils/ordering.py`
...
- Create: `src/envdiff/parsers/dotenv.py`
...
- Create: `src/envdiff/parsers/python_ast.py`
- Create: `src/envdiff/parsers/compose.py`
...
- Create: `src/envdiff/analyzers/scan.py`
- Create: `src/envdiff/utils/paths.py`
...
- Create: `src/envdiff/analyzers/compare.py`
- Create: `src/envdiff/render/human.py`
- Modify: `src/envdiff/cli.py`
...
- Create: `src/envdiff/analyzers/doctor.py`
- Modify: `src/envdiff/cli.py`
